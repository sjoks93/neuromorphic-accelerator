...
/* Logical weight lane bit-width carried by one unified-memory lane. */
#define NMC_WEIGHT_LANE_BITS 16u
/* Accumulator width in multiples of NMC_WEIGHT_LANE_BITS. */
#define NMC_ACCUMULATOR_WEIGHT_MULTIPLE 2u
/* Activation state/parameter word width in multiples of NMC_WEIGHT_LANE_BITS. */
#define NMC_ACTIVATION_WORD_WEIGHT_MULTIPLE 1u
#define NMC_ACCUMULATOR_BITS (NMC_ACCUMULATOR_WEIGHT_MULTIPLE * NMC_WEIGHT_LANE_BITS)
#define NMC_ACTIVATION_WORD_BITS (NMC_ACTIVATION_WORD_WEIGHT_MULTIPLE * NMC_WEIGHT_LANE_BITS)
#define NMC_ACCUMULATOR_LANES ((NMC_ACCUMULATOR_BITS + NMC_WEIGHT_LANE_BITS - 1u) / NMC_WEIGHT_LANE_BITS)
#define NMC_ACTIVATION_WORD_LANES ((NMC_ACTIVATION_WORD_BITS + NMC_WEIGHT_LANE_BITS - 1u) / NMC_WEIGHT_LANE_BITS)
